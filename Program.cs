...
namespace Boats {
	class Program {
		...
		string[, ] primarygrid, string[, ] secondarygrid, List < int > intcoords1, List < int > intcoords2, List < int > intcoords3, List < int > intcoords4, List < int > intcoords5, int[] computercoords1, int[] computercoords2, int[] computercoords3, int[] computercoords4, int[] computercoords5, int userguesses, int computerguesses) {
			...
			do {
				...
				while (true) {
					...
					if (regcheck.IsMatch(userguess) && Convert.ToInt32(userguessarray[0]) >= 1 && Convert.ToInt32(userguessarray[0]) <= 8 && Convert.ToInt32(userguessarray[1]) >= 1 && Convert.ToInt32(userguessarray[1]) <= 8) {
